...
//        }
        ...
        vektor(const point & lhs, const point & rhs) :
            m_x(lhs.get_x() - rhs.get_x()),
            m_y(lhs.get_y() - rhs.get_y()),
            m_z(lhs.get_z() - rhs.get_z()) {
        }
